...
# Configuration variables for message rate limiting and reconnect settings in the IRC backend.
...
IRC_RECONNECT_ON_KICK = 0  # Reconnect back to a channel after a kick (in seconds)
