...
class VersionChecker(BotPlugin):
    ...
    def _async_vcheck(self):
        ...
        if installed_version < current_version:
            ...
            self.warn_admins(
                f"Version {current_version_txt} of Errbot is available. http://pypi.python.org/pypi/errbot/{current_version_txt}. To disable this check do: {self._bot.prefix}plugin blacklist VersionChecker"
            )
