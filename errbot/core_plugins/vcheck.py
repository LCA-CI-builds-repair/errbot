...
class VersionChecker(BotPlugin):
    ...
    def _async_vcheck(self):
        ...
        if installed_version < current_version:
            ...
            self.warn_admins(
                f"Version {current_version_txt} of Errbot is available. " f"http://pypi.python.org/pypi/errbot/{current_version_txt}. "
                f"To disable this check do: {self._bot.prefix}plugin blacklist VersionChecker"  # This line might wrap
            )
